        ...
        <div class="page-content container-fluid">
          <div class="widget">
            <div class="widget-heading">
              <h3 class="widget-title">Add Bucket</h3>
            </div>
            <div class="widget-body">
              <form id="form-horizontal" method="post" novalidate="novalidate" class="form-horizontal">
                <div class="form-group">
                  <label for="txtBucketName" class="col-sm-2 control-label">Bucket Name:</label>
                  <div class="col-sm-10">
                    <input id="txtBucketName" type="text" name="txtBucketName" placeholder="Bucket Name" data-rule-required="true" data-rule-rangelength="[10,30]" data-rule-email="true" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label for="txtBucketDescription" class="col-sm-2 control-label">Bucket Description</label>
                  
                  <div class="col-sm-10">
                    <input id="txtBucketDescription" type="text" name="txtBucketDescription" placeholder="Bucket Description" data-rule-required="true" data-rule-phoneus="true" class="form-control">
                  </div>
                </div>
                <div class="form-group">
