...
<html lang="en">
  <head>
    ...
    <title>Sigma App - Data Tables</title>
    <!-- PACE-->
    ...
    <link rel="stylesheet" type="text/css" href="css/colReorder.bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="css/keyTable.bootstrap.min.css">
  ...
  <body>
    ...
    <header>
      ...
      </form><a href="index.html" class="brand"><img src="images/logo-dark.png" alt="" width="100"></a>
      <ul class="notification-bar list-inline pull-right">
        ...
        <li class="dropdown"><a id="dropdownMenu1" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle bubble header-icon"><i class="ion-alert"></i><span class="badge bg-danger">6</span></a>
          <div aria-labelledby="dropdownMenu1" class="dropdown-menu dropdown-menu-right dm-medium animated fadeInUp">
            ...
            <ul data-mcs-theme="minimal-dark" class="media-list mCustomScrollbar">
              ...
              <li class="media"><a href="javascript:;">
                  <div class="media-left avatar"><img src="images/11.jpg" alt="" class="media-object img-circle"><span class="status bg-danger"></span></div>
                  <div class="media-body">
              ...
              <li class="media"><a href="javascript:;">
                  <div class="media-left avatar"><img src="images/05.jpg" alt="" class="media-object img-circle"><span class="status bg-success"></span></div>
                  <div class="media-body">
              ...
              <li class="media"><a href="javascript:;">
                  <div class="media-left avatar"><img src="images/13.jpg" alt="" class="media-object img-circle"><span class="status bg-warning"></span></div>
                  <div class="media-body">
        ...
        <li class="dropdown hidden-sm hidden-xs"><a id="dropdownMenu2" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle header-icon lh-1 pt-10 pb-10">
            <div class="media mt-0">
              <div class="media-left avatar"><img src="images/04.jpg" alt="" class="media-object img-circle"><span class="status bg-success"></span></div>
        ...
        <div class="page-content container-fluid">
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="widget">
                <div class="widget-heading">
                  <h3 class="widget-title">Data Export</h3>
                </div>
                <div class="widget-body">
              ...
              <div class="widget">
                <div class="widget-heading">
                  <h3 class="widget-title">Reorder Columns</h3>
                </div>
                <div class="widget-body">
                  <table id="example-3" cellspacing="0" width="100%" class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        <th>Name</th>
                        <th>Position</th>
              ...
              <div class="widget">
                <div class="widget-heading">
                  <h3 class="widget-title">KeyTable</h3>
                </div>
                <div class="widget-body">
                  <table id="example-5" cellspacing="0" width="100%" class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        <th>Name</th>
                        <th>Position</th>
              ...
              <div class="widget">
                <div class="widget-heading">
                  <h3 class="widget-title">Select</h3>
                </div>
                <div class="widget-body">
              ...
              <div class="widget">
                <div class="widget-heading">
                  <h3 class="widget-title">Fixed Header</h3>
                </div>
                <div class="widget-body">
                  <table id="example-9" cellspacing="0" width="100%" class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        <th>Name</th>
                        <th>Position</th>
              ...
              <div class="widget">
                <div class="widget-heading">
                  <h3 class="widget-title">Fixed Columns</h3>
                </div>
                <div class="widget-body">
                  <table id="example-8" cellspacing="0" width="100%" class="table table-striped table-bordered nowrap">
                    <thead>
                      <tr>
                        <th>First name</th>
                        <th>Last name</th>
